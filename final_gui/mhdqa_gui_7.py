...
# "<h1 style='font-family:Helvetica; color:#6B96C3;'><b>Ask Me Anything</b></h1>",
...
with col3:
    st.markdown(
        "<h2 style='text-align: right; background-color: rgba(255, 255, 255, 0.1); border-radius: 15px; padding: 10px;'><i>Document Based Question Answering</i></h2>",
        unsafe_allow_html=True
    )
